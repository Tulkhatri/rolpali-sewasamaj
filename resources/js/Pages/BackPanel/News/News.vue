...
const editNews = (id) => {
    router.post("/admin/news/form", { id }, { preserveState: true });
};
const deleteNews = (id) => {
    router.post("/admin/news/delete", { id }, { preserveState: true });
};
            ...
            <div class="right">
                <div class="button-wrapper flex justify-between gap-1">
                    ...
                    >
                        ...
                        >
                            <Link :href="route('admin.news.form')"
                                >Add
                                <font-awesome-icon
                                    :icon="['fas', 'plus']"
                                    class="ml-2"
