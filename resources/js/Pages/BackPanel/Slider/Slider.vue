...
const editSlider = (id) => {
    router.post("/admin/slider/form", { id }, { preserveState: true });
};
const deleteSlider = (id) => {
    router.post("/admin/slider/delete", { id }, { preserveState: true });
};
    ...
    <div class="mr-5 shadow-[0_0_2px_0px_#B9B9B9] w-full">
            ...
            <div class="right">
                <div class="button-wrapper flex justify-between gap-1">
                    ...
                    >
                        ...
                        >
                            <Link :href="route('admin.slider.form')"
                                >Add
                                <font-awesome-icon
                                    :icon="['fas', 'plus']"
                                    class="ml-2"
        ...
        <div class="table-wrapper m-3 overflow-y-scroll h-[67vh]">
            ...
            >
                ...
                <tbody>
                    <tr v-for="(item, index) in slider.data" :key="item.id">
        ...
        <div class="m-4">
            <PaginationLink :paginator="slider" />
        </div>
    </div>
</template>
