...
<template>
    ...
    <div class="mission-area bg-gray-100 mt-20 py-20">
        ...
        <div class="mission-row mt-10 px-5 flex items-center flex-col lg:flex-row lg:px-56  gap-5">
            <div v-if="aboutus?.mission1_title"  class="mission-container basis-[32%] relative group">
            ...
            <div v-if="aboutus?.mission2_title" class="mission-container basis-[32%] relative group">
                <div class="mission-wrapper">
                    <div class="image-wrapper">
                        <img class="h-56"
            ...
            <div v-if="aboutus?.mission3_title" class="mission-container basis-[32%] relative group">
                <div class="mission-wrapper">
                    <div class="image-wrapper">
                        <img class="h-56"
