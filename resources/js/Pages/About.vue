...
<template>
    ...
    <div class="mission-area bg-gray-100 py-20">
        <div class="mx-56">
            ...
            <p class="text-center mt-2">Team short description..........</p>
        </div>
        <div class="mission-row mt-10 px-56 flex items-center flex-wrap gap-5">
            <div class="mission-container basis-[22%]">
                <div class="image-wrapper">
                    <img src="../../assets/images/swiper/slider3.jpeg" alt="" />
                </div>
                <div class="title-detail-wrapper py-4 px-4 bg-red-600 text-center text-white">
